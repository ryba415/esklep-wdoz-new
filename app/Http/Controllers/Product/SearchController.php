...
{
    public function showSearchresultsJson(Request $request){
        return $this->showSearchresults($request, true);
    }

    public function showSearchresults(Request $request, $returnJson = null){
        $viewData = [];
        ...
        if ($returnJson === true || $request->wantsJson()) {
            return response()->json([
                'products' => $viewData['products'],
                'pagination' => [
                    'total' => $viewData['allProductsInCategoryCount'],
                    'per_page' => $productsPerPage,
                    'current_page' => $pageNumber,
                    'last_page' => $allPagesCount,
                    'from' => $viewData['productsStartFor'],
                    'to' => $viewData['productsEndFor'],
                ],
                'sortBy' => $viewData['sortBy'],
                'isSearch' => true,
                'category' => $viewData['category'],
                'breadcrumbs' => $viewData['breadCrumbsCategories'],
            ]);
        }
