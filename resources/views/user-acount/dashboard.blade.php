...
<nav class="">
    <ol class="mt-5 mb-5 flex flex-wrap items-center justify-around pl-2 pr-2 gap-y-1">
        <li class="crumb "><a id="show-user-data" class="xl:min-w-[170px]  cursor-pointer inline-block m-auto bg-wdoz-primary-10 rounded-lg mb-5 border-solid border-wdoz-primary border-2 text-center max-w-[350px] p-1" >Moje dane <span class="text-[#008641] font-bold ml-1">></span></a></li>
