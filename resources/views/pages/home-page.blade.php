    ...
    <section class="bg-[#f7f7f7] flex w-full items-center justify-center py-16 min-h-[200px]">
        <div class="w-full max-w-[1620px] mx-auto px-5 gap-5">
            <div class="flex flex-wrap 2xl:flex-nowrap  justify-center gap-5">
                <div style="width: 18%" class=" w-[20%] flex-grow flex-shrink-0 min-w-[180px]  ">
                    <div class="home-page-extra-box h-[450px] flex justify-end bg-contain bg-no-repeat bg-[rgba(201,228,223,1)] flex flex-col items-center p-6 pb-3 rounded-2xl 2xl:h-[450px] bg-contain bg-center-center" 
                        @if (isset($topCategories[0]) && $topCategories[0]->image_mobile != '' && $topCategories[0]->image_mobile != null) style="@if ($topCategories[0]->color != '' && $topCategories[0]->color != null) background-color: {{$topCategories[0]->color}}; @endif background-image: url('/images/category-images/{{$topCategories[0]->image_mobile}}') @endif ">
                        <div class="home-page-box-background bg-[rgba(201,228,223,1)]" style=" @if ($topCategories[0]->color != '' && $topCategories[0]->color != null) background-color: {{$topCategories[0]->color}}; @endif ">
                ...
                <div style="width: 18%" class="w-[20%] flex-grow flex-shrink-0    min-w-[180px] ">
                    <div class="home-page-extra-box h-[450px] flex justify-end bg-contain bg-no-repeat bg-[rgba(197,222,242,1)] flex-col items-center p-6 pb-3 rounded-2xl 2xl:h-[450px] bg-center-center" 
                         @if (isset($topCategories[1]) && $topCategories[1]->image_mobile != '' && $topCategories[1]->image_mobile != null) style="@if ($topCategories[1]->color != '' && $topCategories[1]->color != null) background-color: {{$topCategories[1]->color}}; @endif background-image: url('/images/category-images/{{$topCategories[1]->image_mobile}}') @endif ">
                        <div class="bg-[rgba(197,222,242,1)] home-page-box-background" style=" @if ($topCategories[1]->color != '' && $topCategories[1]->color != null) background-color: {{$topCategories[1]->color}}; @endif ">
                ...
                <div style="width: 18%" class="w-[20%] flex-grow flex-shrink-0   min-w-[180px] ">
                    <div class="home-page-extra-box h-[450px] flex justify-end bg-contain bg-no-repeat bg-[rgba(219,205,240,1)] flex-col items-center p-6 pb-3 rounded-2xl 2xl:h-[450px] bg-center-center" 
                         @if (isset($topCategories[2]) && $topCategories[2]->image_mobile != '' && $topCategories[2]->image_mobile != null) style="@if ($topCategories[2]->color != '' && $topCategories[2]->color != null) background-color: {{$topCategories[2]->color}}; @endif background-image: url('images/category-images/{{$topCategories[2]->image_mobile}}') @endif ">
                        <div class="bg-[rgba(219,205,240,1)] home-page-box-background" style=" @if ($topCategories[2]->color != '' && $topCategories[2]->color != null) background-color: {{$topCategories[2]->color}}; @endif ">
                ...
                <div style="width: 18%" class="w-[20%] flex-grow flex-shrink-0   min-w-[180px] ">
                    <div class="home-page-extra-box h-[450px] flex justify-end bg-contain bg-no-repeat bg-[rgba(242,198,223,1)] flex-col items-center p-6 pb-3 rounded-2xl 2xl:h-[450px] bg-center-center" 
                         @if (isset($topCategories[3]) && $topCategories[3]->image_mobile != '' && $topCategories[3]->image_mobile != null) style="@if ($topCategories[3]->color != '' && $topCategories[3]->color != null) background-color: {{$topCategories[3]->color}}; @endif background-image: url('/images/category-images/{{$topCategories[3]->image_mobile}}') @endif ">
                        <div class="bg-[rgba(242,198,223,1)] home-page-box-background" style=" @if ($topCategories[3]->color != '' && $topCategories[3]->color != null) background-color: {{$topCategories[3]->color}}; @endif ">
                ...
                <div style="width: 18%" class="w-[20%] flex-grow flex-shrink-0  min-w-[180px] ">
                    <div class="home-page-extra-box h-[450px] flex justify-end bg-contain bg-no-repeat bg-[rgba(248,217,196,1)] flex-col items-center p-6 pb-3 rounded-2xl 2xl:h-[450px] bg-center-center" 
                        ...
                        <div class="bg-[rgba(248,217,196,1)] home-page-box-background" style=" @if ($topCategories[4]->color != '' && $topCategories[4]->color != null) background-color: {{$topCategories[4]->color}}; @endif ">
