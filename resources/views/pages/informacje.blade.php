...
<p><img alt="przykład zmiany hasła - esklep wdoz" class="m-auto mt-2 mb-4" src="/img/zmia-hasla-example.png"></p>

<h2 class="text-lg">Rejestracja:</h2>

<p>Aby zarejestrować się do wracamdozdrowia.pl należy klikną ikonę <svg class="logged-svg inline-block" height="15" viewBox="0 0 3.969 3.969" width="15" xmlns="http://www.w3.org/2000/svg"> <g fill="none" stroke="#008641" stroke-width=".27" transform="translate(0 -293.031)"> <ellipse cx="-3.747" cy="294.481" rx=".926" ry="1.091" stroke-linejoin="bevel" transform="skewX(1.113) scale(1 .99981)"></ellipse> <path d="M2.622 295.724h.709l.33.342v.65l-.082.071h-.603.59l.107-.07-.023-.65-.343-.355zM1.353 295.718H.645l-.331.343v.65l.082.07H1h-.59l-.107-.07.024-.65.342-.354z" stroke-linejoin="round"></path> <path d="M1 296.781l2.077.006z"></path> </g> </svg> „konto użytkownika-logowanie”, znajdującą się w górnym prawym rogu strony internetowej apteki wdoz.pl.</p>

<p><img alt="ikona logowania - esklep wdoz" class="m-auto mt-2 mb-4" src="/img/rejestracja-example.png"></p>
...
<p>Po kliknięciu w otrzymany link zaloguj się do wracamdozdrowia.pl wpisując adres e-mail oraz hasło podane przy rejestracji.</p>

<p>Po złożeniu zamówienia i zakończeniu przeglądania oferty wracamdozdrowia.pl wyloguj się klikając ikonę <strong>„wyloguj”</strong>.</p>

<p>Zalety posiadania konta na stronie wracamdozdrowia.pl:</p>
...
<p>Zachęcamy do prenumeraty Newslettera wracamdozdrowia.pl. Dzięki temu będziemy Cię informować na bieżąco o wszelkich promocjach i nowościach w naszej ofercie.</p>

<h2 class="text-lg">Koszyk</h2>
...
<p>Jeżeli chcesz otrzymywać informacje o promocjach, nowościach, bieżących doniesieniach medycznych we wracamdozdrowia.pl, wpisz swój adres e-mail w okienko Newslettera, zaakceptuj regulamin serwisu wdoz.pl i kliknij strzałkę.</p>

<p><img alt="zapis do newslettera - esklep wdoz" class="m-auto mt-2 mb-4" src="/img/newsletter-example.png"></p>
...
<p>Dane z Newslettera będą przetwarzane zgodnie z polityką prywatności wracamdozdrowia.pl.</p>