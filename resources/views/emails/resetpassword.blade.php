         ...
         <div style="background-color: #f9f9f9; padding: 20px;">
             ...
             <div  style="max-width: 600px; margin: 0 auto; margin-top: 30px; ">
                 ...
                 <div style="text-align: center; width: 100%; margin-top: 20px;">
                     ...
                     <h1 style="text-align: center; width: 100%">Resetowanie hasła - Legesfera</h1>
                 </div>
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-2">
                         <div>
                             <div style="margin-top: 20px;">
                                <p>Poniżej znajduje się link do zresetowania hasła. Kliknij w niego aby zmienić hasło.</p>
