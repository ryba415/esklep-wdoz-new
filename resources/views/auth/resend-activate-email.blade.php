...
<div class="login-container">
        <h1>Wyślij ponownie link do aktywacji konta</h1>
        <div class="login-card">
                ...
                <form action="/resend-activate-email-sumbmit" method="post">
                    ...
                    <div class="button-container">
                        <input type="submit" class="standard-big-button standard-big-button-orange" value="Wyślij link do aktywacji konta">
                    </div>
