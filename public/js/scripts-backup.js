...
function scrollSlider(container, sliderTrack, sliderData, prevBtn, nextBtn, direction) {
    ...
    /*checkbox akceptacja warunkow */
      ...
      if (checkboxButton && hiddenCheckbox && checkIcon) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            let menuItems = document.getElementById('desktop-category-menus').querySelectorAll('.desktop-category-container');
            ...
            /*for (let i=0;i<menuItems.length;i++){
                ...
                menuItems[i].addEventListener('click', function(e) {
                    ...
                    console.log(menuId);
                    let submenuContainer = document.getElementById('mega-menu-container-'+menuId);
                    console.log(submenuContainer);
                    if (submenuContainer != null){
                        submenuContainer.classList.remove('hidden');
                    }
                    let submenuSubContainer = document.getElementById('mega-menu-sub-container-'+menuId);
                    console.log(submenuSubContainer);
                    if (submenuSubContainer != null){
                        submenuSubContainer.classList.remove('hidden');
                    }
                }, false);
    ...
    window.showSubMenu = function showSubMenu(menuId){
        let submenuContainer = document.getElementById('mega-menu-container-'+menuId);
        console.log('showww!');
        if (submenuContainer != null){
            submenuContainer.classList.remove('hidden');
    ...
    window.hideSubMenu = function hideSubMenu(menuId){
        let submenuContainer = document.getElementById('mega-menu-container-'+menuId);
        console.log('hiiide!');
        if (submenuContainer != null){
            submenuContainer.classList.add('hidden');
        ...
        console.log(submenuSubContainer);
        if (submenuSubContainer != null){
            submenuSubContainer.classList.add('hidden');
        }
    };
